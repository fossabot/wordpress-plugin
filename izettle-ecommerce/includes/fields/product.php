<div class="search-form product-search">
    ...
    <span class="search-control">
        <?php echo file_get_contents(plugins_url( '../../dist/img/svg/zoom.svg?v=' . izettle()->version, __FILE__ )); ?>
...
<div class="product-pager" hidden>
    <button type="button" class="btn-faux-link product-pager__control" data-page="previous" disabled>
        <span>
            <?php echo file_get_contents(plugins_url( '../../dist/img/svg/arrow-left.svg?v=' . izettle()->version, __FILE__ )); ?>
    ...
    <button type="button" class="btn-faux-link product-pager__control" data-page="next" disabled>
        <span>
            ...
            <?php echo file_get_contents(plugins_url( '../../dist/img/svg/arrow-right.svg?v=' . izettle()->version, __FILE__ )); ?>
        </span>
    </button>
</div>