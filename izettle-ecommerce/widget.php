...
class iZettle_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$instance = wp_parse_args( (array) $instance, izettle()->default_args() );
	...
	function form( $instance ) {
		...
		include( izettle()->dir . '/includes/fields-widget.php' );
	}
