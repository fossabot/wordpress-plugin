($ => {
    class Modal {
        constructor() {
            this.$element = $('.izettle-modal');

            if (!this.$element.length) {
                return;
            }

            this.$backdrop = $('.izettle-modal-backdrop');
            this.$controls = $('.izettle-modal-controls');
        ...
        load(values = {}) {
            const { ajaxurl, izettlevars } = window;
            const { action, nonce } = izettlevars;
            ...
            $.post(
                ...
                data => {
                    ...
                    this.form = new window.iZettleForm(this.$form);
        ...
        show(kind) {
            ...
            if (node) {
                ...
                if (shortcode.startsWith(`[${window.izettlevars.slug}`)) {
        ...
        insert() {
            ...
            const shortcode = `[${window.izettlevars.slug} ${props}]`;
