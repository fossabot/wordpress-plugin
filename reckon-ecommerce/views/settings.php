            ...
            <div class="padding-6">
                <div class="text-center padding-4">
                    ...
                    <?php } else {
                        ...
                        <p><?php printf(
                            __( 'Connected to %s. %s', reckon()->lang ),
                            '<strong>' . $store->display_name . '</strong>',
                            '<a href="' . esc_url( reckon()->api->disconnect_url() ) . '">' . __( 'Disconnect', reckon()->lang ) . '</a>'
                        ); ?></p>
                ...
                <?php } else { ?>
                    <aside class="padding-top-4">
                        <div>
                            <h4 class="margin-bottom-1"><?php printf( __( 'Need an %s account?', reckon()->lang ), reckon()->name ); ?></h4>
