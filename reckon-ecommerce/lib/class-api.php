...
class Reckon_API
{
    ...
    {
        $this->slug     = reckon()->slug;
        $this->version  = reckon()->version;
        $this->lang     = reckon()->lang;
        $this->name     = reckon()->name;
    ...
    {
        $args = array(
            'action' => 'disconnect_' . reckon()->slug,
        );
    ...
    public function get_first_token($current_screen)
    {
        ...
        if ($current_screen->id != 'toplevel_page_' . reckon()->slug) {
            return;
        }
